...
ActiveRecord::Schema.define(version: 2021_06_28_042327) do
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.integer "capacity_adult"
    t.integer "capacity_child"
  end

  create_table "publisher_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "address"
    t.integer "age"
    t.string "gender"
    t.text "survey_quest"
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "status", default: 0
    t.index ["user_id"], name: "index_publisher_infos_on_user_id"
  end
